...
struct stateStruct
{ //! State Structure to access all values
    string name;
    int loopstate;
    F_Struct F;
    D_Struct D;
...
void printCurrentState(stateStruct s, int loop)
{
    ...
    if (file.is_open())
    {
        ...
        file << "~F.PC bin      : " << s.F.PC << endl
             << endl;

        file << "~D.Ins_Mem   : " << s.D.Ins_Mem << endl
             << endl;
        ...
        file << "~E.wrt_enable  : " << s.E.wrt_enable << endl
             << endl;
        ...
        file << "~M.wrt_enable  : " << s.E.wrt_enable << endl
             << endl;
        ...
        file << "~W.wrt_enable  : " << s.E.wrt_enable << endl
             << endl;
